...
class LTCC(object):
    ...
    def _process_dir_train(self, dir_path):
        ...
        for img_path in img_paths:
            ...
            unclo_path = img_path.replace('/train/', '/train_rgb_unclo/')
            clo_path = img_path.replace('/train/', '/train_rgb_clo/')
            # head_path = img_path.replace('/train/', '/train_mask_head/')
            parsing_path = img_path.replace('/train/', '/train_parsing/').replace('.png', '.npy')
            parsing_label = self.parsing(parsing_path)
            dataset.append((img_path, pid, camid, clothes_id, parsing_label, unclo_path, clo_path))
