...
from losses.parsing_loss import ParsingLoss
...
def build_losses(config, num_train_clothes):
    ...
    criterion_parsing = ParsingLoss()
    return criterion_cla, criterion_pair, criterion_clothes, criterion_cal, criterion_mmd, criterion_parsing
